...
public class DeviceScanActivity extends ListActivity {
    ...
    private String nameaddr[] = new String[2];
    private boolean checkyesno = true;
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (deviceName != null && deviceName.length() > 0)
                viewHolder.deviceName.setText(deviceName);          //리스트뷰 에서 디바이스 이름 출력하는 코드
            else
                viewHolder.deviceName.setText(R.string.unknown_device);
            viewHolder.deviceAddress.setText(device.getAddress());  //리스트뷰 에서 디바이스 주소 출력하는 코드
